    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(verbose_name='商品SPU', to='goods.Goods', on_delete=models.DO_NOTHING)),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(verbose_name='商品', to='goods.GoodsSKU', on_delete=models.DO_NOTHING)),
            ],
            options={
                'verbose_name': '首页轮播商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
                ('sku', models.ForeignKey(verbose_name='商品SKU', to='goods.GoodsSKU', on_delete=models.DO_NOTHING)),
                ('type', models.ForeignKey(verbose_name='商品类型', to='goods.GoodsType', on_delete=models.DO_NOTHING)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goodssku',
            name='type',
            field=models.ForeignKey(verbose_name='商品种类', to='goods.GoodsType', on_delete=models.DO_NOTHING),
        ),
        migrations.AddField(
            model_name='goodsimage',
            name='sku',
            field=models.ForeignKey(verbose_name='商品', to='goods.GoodsSKU', on_delete=models.DO_NOTHING),
        ),
    ]
